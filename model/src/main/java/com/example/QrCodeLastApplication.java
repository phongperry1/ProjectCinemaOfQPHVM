...
public class QrCodeLastApplication {
	...
	public static void main(String[] args) {
		...
		// context.getBean(PurchaseHistoryService.class);
		...
		// }
		// CinemaOwnerService cinemaOwnerService =
		// context.getBean(CinemaOwnerService.class);
		// Integer UserId = 1;
		// List<PurchaseHistory> histories =
		// historyService.getPurchaseHistoryById(UserId);
		...
		// UserByAdminService userByAdminService =
		// context.getBean(UserByAdminService.class);
