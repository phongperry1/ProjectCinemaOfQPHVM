...
public String updateUserRank(@PathVariable("UserId") String UserId, Model model) {
    Users user = userByAdminService.findById(UserId);
...
public String showUpdateRankForm(@PathVariable("UserId") String UserId, Model model) {
    Users user = userByAdminService.findById(UserId);
...
public String lockAccount(@PathVariable("UserId") String userId, Model model) {
    Users user = userByAdminService.findById(userId);
