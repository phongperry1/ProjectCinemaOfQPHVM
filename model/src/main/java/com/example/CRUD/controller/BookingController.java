...
public class BookingController {
    ...
    public String showBookingPage(Model model, @PathVariable("movieid") Integer movieid,
    ...
    public List<ScreeningRoom> getRoomName(@RequestParam int theaterID,
        ...
        List<ScreeningRoom> screeningroom = screeningRoomRepository
                .findScreeningRoomsByTheaterIdAndMovieIdAndShowTimeAndShowDate(theaterID, movieID, showTime, showDate,
                        showTimeId);
